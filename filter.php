      ...
      <div class="section my-4">
          ...
          <div class="col-lg-10 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
              <select class="form-select" aria-label="Default select example">
                <option selected>Sort by: <span id="selectSort">Position</span> </option>
                <option value="1">Position</option>
                <option value="2">Date</option>
                <option value="3">Name</option>
              </select>
              <select class="form-select" aria-label="Default select example">
                <option selected>Show: <span id="selectPage">35 per page</span> </option>
        ...
        <div class="row">
          <div class="col-lg-2 bg-four pt-4 h-fit">
            <h4 class="text-center font-poppins fs-4 fw-bold">Filters</h4>
            <a href="#" type="button" class="text-center d-block btn btn-outline-secondary m-auto my-3">Clear Filter</a>
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <div class="input-group">
                  <input type="text" aria-label="Fprice" placeholder="From" class="form-control">
                  <span class="input-group-text">
                    <i class="bi bi-dash-lg"></i>
                  </span>
                  <input type="text" aria-label="Lprice" placeholder="To" class="form-control">
                </div>
              </li>
              <li>
                <button type="button" class="w-100 mt-2 btn btn-danger">Filter</button>
              </li>
            </ul>
            <ul class="list-unstyled">
              <li class="text-heading p-2 fw-bold fs-5">
            ...
            <ul class="list-unstyled">
                <li>
                  <button type="button" class="btn btn-danger w-100">Clear All</button>
                </li>
            </ul>
            
          </div>
          <div class="col-lg-10 row align-items-start flex-wrap">
