          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title d-flex align-items-center justify-content-between">
                Filter
                <button class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEcommerceCategoryList" aria-controls="DataTables_Table_0">Add Category</button>
              </h5>
    ...
    const handleView = (id) => {
      $.ajax({
        ...
        success: (response) => {
          ...
          $('#ecommerce-category-name-edit').val(data.name);
                ...
                render: function(data, type, row) {
                  ...
                  return `
                      <div class="d-flex align-items-sm-center justify-content-sm-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-end m-0">
                          <a href="javascript:0;" class="dropdown-item" onclick="handleView(${row.id})">View</a>
                          <a href="javascript:0;" class="dropdown-item" onclick="handleDelete(${row.id})">Delete</a>
                        </div>
                      </div>
                  `
                }
